...
<template>
  <div
    v-if="open"
    class="fixed inset-0 bg-black/60 backdrop-blur-md grid place-items-center z-50 p-4 select-none"
    ...
    >
      ...
      <div class="mb-4">
        ...
        >
          ...
          Tienes {{ cancelledDates.length }} día(s) bloqueado(s) por cancelación
          previa. Selecciona otra fecha.
        </p>
      </div>
